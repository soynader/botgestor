...
const getDash = async (req, res) => {
    try {
        ...
        const allowAPI = plan.allowapi == 1 ? true : false
...
export { signup, login, delLogs, delScrapping, getDash, userRecovery, updateUser, updateRecoverPass, sendNewPing, getMyPing, getScrapCampaign, getScrappingData, startScrap, getUserByToken, getMessageLog, GenAPI, V2SendMesg, V2SendTemp }
